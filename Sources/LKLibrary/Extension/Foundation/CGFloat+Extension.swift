...
import UIKit
extension CGFloat: LKExCompatible {}
// MARK: - 一、CGFloat 的基本转换
public extension LKEx where Base == CGFloat {
    ...
    // MARK: 1.5、转 String
    /// 转 String
    var string: String { return String(self.base.ex.double) }
    
    // MARK: 1.6、转 NSNumber
    /// 转 NSNumber
    var number: NSNumber { return NSNumber(value: self.base.ex.double) }
