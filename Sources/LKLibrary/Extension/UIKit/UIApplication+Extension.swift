...
extension UIApplication: LKExCompatible {}
// MARK: - 一、基本的扩展
public extension LKEx where Base: UIApplication {
    ...
    static var userAgent: String {
        ...
        return "JK" + Bundle.ex.appVersion
    }
    
    // MARK: 1.4、app定位区域
    /// app定位区域
    static var localizations: String? {
        guard let weakInfoDictionary = Bundle.ex.infoDictionary, let content = weakInfoDictionary[String(kCFBundleLocalizationsKey)] else {
            return nil
        }
