...
// MARK: - 一、基本的扩展
extension UIViewController: LKExCompatible {}
public extension LKEx where Base: UIViewController {
...
public extension LKEx where Base: UIViewController {
    ...
    func presentSafari(_ defaultKey: String, _ isAllowedCharacters: Bool = false ) {
        ...
        if let url = URL(string: eco) {
            ...
            self.base.present(sf, animated: true, completion: nil)
        }
    }
}
...
@objc extension UIViewController {
    ...
    override public class func initializeMethod() {
        ...
        if self == UIViewController.self {
            ...
            DispatchQueue.ex.once(token: onceToken) {
